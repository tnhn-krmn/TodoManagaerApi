using TodoManager.Business.Concrete;
...
using AppSettings = TodoManager.Business.Helper.AppSettings;
...
namespace TodoManager.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IJwtAuthenticationService, JwtAuthenticationManager>();
            services.AddScoped<ITodoService, TodosManager>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "TodoManager.API", Version = "v1" });
            });
        }
